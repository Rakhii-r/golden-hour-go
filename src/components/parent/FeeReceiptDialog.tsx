...
export function FeeReceiptDialog({ open, onOpenChange, data }: Props) {
        ...
        <div className="overflow-auto bg-muted/30 p-6 flex justify-center">
          {data ? (
            <div className="shadow-lg">
              <FeeReceipt ref={ref} data={data} />
            </div>
          ) : (
            <div className="py-12 text-sm text-muted-foreground">Loading receipt…</div>
          )}
        </div>
      </DialogContent>
    </Dialog>
